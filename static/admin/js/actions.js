...
(function($) {
    ...
    $.fn.actions = function(opts) {
        let options = $.extend({}, $.fn.actions.defaults, opts);
        let actionCheckboxes = $(this);
        ...
        let showQuestion = function() {
            ...
            updateCounter = function() {
                let sel = $(actionCheckboxes).filter(":checked").length;
                // data-actions-icnt is defined in the generated HTML
                // and contains the total amount of objects in the queryset
                let actions_icnt = $('.action-counter').data('actionsIcnt');
    ...
    $(document).ready(function() {
        let $actionsEls = $('tr input.action-select');
